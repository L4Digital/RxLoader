...
[![Download](https://img.shields.io/badge/JCenter-1.1.0-brightgreen.svg?style=flat-square)](https://bintray.com/l4digital/maven/RxLoader/_latestVersion)
...
~~~groovy
dependencies {
    compile 'com.l4digital.rxloader:rxloader:1.1.0'
}
~~~
